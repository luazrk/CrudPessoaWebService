...
$.ajax({
  ...
  url:"https://wordpress-online-2.000webhostapp.com/webservice/cadastra.php", //para onde esta enviando
  data:parametros,//oque vou enviar
  //se der certo
...
dataType: "json", //oque vou receber ou como receber
success:function (data){
  var itemlista = "";
...
$.ajax({
  type:"post", //como vou enviar os dados
  url:"https://wordpress-online-2.000webhostapp.com/webservice/atualiza.php", //para onde esta enviando
  data:parametros,//oque vou enviar
  //se der certo
  success: function(data){
    navigator.notification.alert(data);
...
$.ajax({
  type:"post", //como vou enviar os dados
  url:"https://wordpress-online-2.000webhostapp.com/webservice/delete.php", //para onde esta enviando
  data:parametros,//oque vou enviar
  //se der certo
  success: function(data){
    navigator.notification.alert(data);
